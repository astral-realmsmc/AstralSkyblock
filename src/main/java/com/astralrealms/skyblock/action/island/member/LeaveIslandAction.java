...
/** Menu action: {@code [leave-island] <island>} — the owner is refused by the service. */
public record LeaveIslandAction(PlaceholderWrapper<Island> island) implements PaperAction {
    ...
    public void run(PaperActionContext context) throws ExecutableRunException {
        ...
        AstralSkyblock.get().members().leave(island, player);
    }
}
